...
Version  : 2.23.1
Release  : 79
URL      : https://files.pythonhosted.org/packages/99/c4/2ee76035dbe930c033768a2280109f994094e1455d776978c45cb6e652ec/google-auth-2.23.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/c4/2ee76035dbe930c033768a2280109f994094e1455d776978c45cb6e652ec/google-auth-2.23.1.tar.gz
...
%prep
%setup -q -n google-auth-2.23.1
cd %{_builddir}/google-auth-2.23.1
pushd ..
cp -a google-auth-2.23.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695825495
