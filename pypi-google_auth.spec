...
Source0  : https://files.pythonhosted.org/packages/9e/9b/e92ef23b84fa10a64ce4831390b7a4c2e53c0132568d99d4ae61d04c8855/google_auth-2.40.3.tar.gz
...
%prep
%setup -q -n google_auth-2.40.3
cd %{_builddir}/google_auth-2.40.3
pushd ..
cp -a google_auth-2.40.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749138158
