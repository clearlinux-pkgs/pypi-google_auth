...
Source0  : https://files.pythonhosted.org/packages/71/10/8a86f8c81350bff52399b9e1125bc72963812c179567e5e6e93dd74c0bbb/google-auth-2.27.0.tar.gz
...
%prep
%setup -q -n google-auth-2.27.0
cd %{_builddir}/google-auth-2.27.0
pushd ..
cp -a google-auth-2.27.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706200730
