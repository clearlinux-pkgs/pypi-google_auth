...
Source0  : https://files.pythonhosted.org/packages/fd/8c/3c24a436775d6582effe4ecaf33b2562e6a7f0cbc647a293c764c5eac9ee/google-auth-2.6.6.tar.gz
...
%prep
%setup -q -n google-auth-2.6.6
cd %{_builddir}/google-auth-2.6.6
pushd ..
cp -a google-auth-2.6.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653333395
...
cp %{_builddir}/google-auth-2.6.6/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_auth/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
