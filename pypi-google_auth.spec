...
Source0  : https://files.pythonhosted.org/packages/66/84/f67f53c505a6b2c5da05c988e2a5483f5ba9eee4b1841d2e3ff22f547cd5/google_auth-2.40.2.tar.gz
...
%prep
%setup -q -n google_auth-2.40.2
cd %{_builddir}/google_auth-2.40.2
pushd ..
cp -a google_auth-2.40.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747864996
