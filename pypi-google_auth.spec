...
Source0  : https://files.pythonhosted.org/packages/e6/76/2217d47be6a03dfd5f6bfe7432f87a5aa5ab6d85525a4dc546df9895f053/google-auth-2.21.0.tar.gz
...
%prep
%setup -q -n google-auth-2.21.0
cd %{_builddir}/google-auth-2.21.0
pushd ..
cp -a google-auth-2.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687883973
