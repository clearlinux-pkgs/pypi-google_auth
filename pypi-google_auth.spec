...
Source0  : https://files.pythonhosted.org/packages/9a/a7/96f6b41c736ac080844a96d34896019127427e66f59d6b03e001d243c6c6/google-auth-2.26.2.tar.gz
...
%prep
%setup -q -n google-auth-2.26.2
cd %{_builddir}/google-auth-2.26.2
pushd ..
cp -a google-auth-2.26.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704986178
