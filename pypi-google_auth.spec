...
Source0  : https://files.pythonhosted.org/packages/93/cd/e9136c12110ec50ddab676c6cb35f913566120c503730820905f64a11230/google-auth-2.13.0.tar.gz
...
%prep
%setup -q -n google-auth-2.13.0
cd %{_builddir}/google-auth-2.13.0
pushd ..
cp -a google-auth-2.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666048522
