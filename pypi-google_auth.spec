...
Source0  : https://files.pythonhosted.org/packages/3b/84/5d156b0736abe57ab060e81775c776602679522c141eb3ca367f31e4d858/google-auth-2.16.1.tar.gz
...
%prep
%setup -q -n google-auth-2.16.1
cd %{_builddir}/google-auth-2.16.1
pushd ..
cp -a google-auth-2.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676769469
