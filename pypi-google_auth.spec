...
Source0  : https://files.pythonhosted.org/packages/46/af/b25763b9d35dfc2c6f9c3ec34d8d3f1ba760af3a7b7e8d5c5f0579522c45/google_auth-2.37.0.tar.gz
...
%prep
%setup -q -n google_auth-2.37.0
cd %{_builddir}/google_auth-2.37.0
pushd ..
cp -a google_auth-2.37.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735095745
