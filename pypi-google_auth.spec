...
Source0  : https://files.pythonhosted.org/packages/18/b2/f14129111cfd61793609643a07ecb03651a71dd65c6974f63b0310ff4b45/google-auth-2.29.0.tar.gz
...
%prep
%setup -q -n google-auth-2.29.0
cd %{_builddir}/google-auth-2.29.0
pushd ..
cp -a google-auth-2.29.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711032591
