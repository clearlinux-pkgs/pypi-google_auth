...
Source0  : https://files.pythonhosted.org/packages/54/62/a13a5cac653075436ef97fc1c7b48eba277c5bfa3c8613617a733a832cbc/google-auth-2.24.0.tar.gz
...
%prep
%setup -q -n google-auth-2.24.0
cd %{_builddir}/google-auth-2.24.0
pushd ..
cp -a google-auth-2.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701720854
