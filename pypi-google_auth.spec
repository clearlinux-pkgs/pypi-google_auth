...
Source0  : https://files.pythonhosted.org/packages/78/30/5f73a9a960dc888f44577f76c34e8437e24b441eadbebabde3d213eccfe3/google-auth-2.11.1.tar.gz
...
%prep
%setup -q -n google-auth-2.11.1
cd %{_builddir}/google-auth-2.11.1
pushd ..
cp -a google-auth-2.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663687744
