...
Source0  : https://files.pythonhosted.org/packages/43/44/a7be6998afbc3c1254f8c4206c11b5ba8c351c574636e7bfcb5209f92e67/google-auth-2.11.0.tar.gz
...
%prep
%setup -q -n google-auth-2.11.0
cd %{_builddir}/google-auth-2.11.0
pushd ..
cp -a google-auth-2.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661192725
