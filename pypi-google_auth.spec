...
Source0  : https://files.pythonhosted.org/packages/cb/8e/8f45c9a32f73e786e954b8f9761c61422955d23c45d1e8c347f9b4b59e8e/google_auth-2.39.0.tar.gz
...
%prep
%setup -q -n google_auth-2.39.0
cd %{_builddir}/google_auth-2.39.0
pushd ..
cp -a google_auth-2.39.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744668799
