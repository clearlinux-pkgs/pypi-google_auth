...
Source0  : https://files.pythonhosted.org/packages/7a/10/b3a860c103832a6a3353b47f9ebcf49ebe7f0c8ccf5cd39e89cffe67d98e/google-auth-2.28.2.tar.gz
...
%prep
%setup -q -n google-auth-2.28.2
cd %{_builddir}/google-auth-2.28.2
pushd ..
cp -a google-auth-2.28.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710170736
