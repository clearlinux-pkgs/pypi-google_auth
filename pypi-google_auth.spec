...
Source0  : https://files.pythonhosted.org/packages/62/80/e143d53aa8d02c3b468d3feaf58a0dd094a8ff1954e2500f9f68a8e8bf8f/google-auth-2.31.0.tar.gz
...
%prep
%setup -q -n google-auth-2.31.0
cd %{_builddir}/google-auth-2.31.0
pushd ..
cp -a google-auth-2.31.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720054597
