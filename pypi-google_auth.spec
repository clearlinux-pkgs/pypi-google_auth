...
Version  : 2.5.0
Release  : 34
URL      : https://files.pythonhosted.org/packages/a8/35/08fccaff6bd77e4e584f783b7463dff5f60b1ab86e67a2db11effcf3288b/google-auth-2.5.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/a8/35/08fccaff6bd77e4e584f783b7463dff5f60b1ab86e67a2db11effcf3288b/google-auth-2.5.0.tar.gz
...
%prep
%setup -q -n google-auth-2.5.0
cd %{_builddir}/google-auth-2.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643214012
...
cp %{_builddir}/google-auth-2.5.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_auth/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
