...
Source0  : https://files.pythonhosted.org/packages/9a/15/ac42556763c08e1b1821a7e55f3a93982c50ca7f25adf8f61a01dd2ed98b/google-auth-2.28.1.tar.gz
...
%prep
%setup -q -n google-auth-2.28.1
cd %{_builddir}/google-auth-2.28.1
pushd ..
cp -a google-auth-2.28.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708615356
