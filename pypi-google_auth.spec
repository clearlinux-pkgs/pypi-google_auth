...
Source0  : https://files.pythonhosted.org/packages/1a/90/0a278aeed278363ab26ccb23529092b48ee3eff8867472236a1b5141f626/google-auth-2.9.1.tar.gz
...
%prep
%setup -q -n google-auth-2.9.1
cd %{_builddir}/google-auth-2.9.1
pushd ..
cp -a google-auth-2.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657725126
...
cp %{_builddir}/google-auth-2.9.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_auth/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
