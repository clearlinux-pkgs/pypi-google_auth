...
Source0  : https://files.pythonhosted.org/packages/ae/bc/b79ffd264b657a2ab59bbfe4786cfbd8d7105e69eea8dcbd3e4ceb71ff71/google-auth-2.9.0.tar.gz
...
%prep
%setup -q -n google-auth-2.9.0
cd %{_builddir}/google-auth-2.9.0
pushd ..
cp -a google-auth-2.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656513270
...
cp %{_builddir}/google-auth-2.9.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_auth/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
