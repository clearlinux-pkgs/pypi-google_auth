...
Source0  : https://files.pythonhosted.org/packages/a1/37/c854a8b1b1020cf042db3d67577c6f84cd1e8ff6515e4f5498ae9e444ea5/google_auth-2.35.0.tar.gz
...
%prep
%setup -q -n google_auth-2.35.0
cd %{_builddir}/google_auth-2.35.0
pushd ..
cp -a google_auth-2.35.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726777120
