...
Source0  : https://files.pythonhosted.org/packages/36/52/699d14b97ae4b1572c8e742c499afbac83b326e908ac26d602f7cbd16ffe/google-auth-2.3.3.tar.gz
...
Provides: google-auth
Provides: google-auth-python
Provides: google-auth-python3
...
%prep
%setup -q -n google-auth-2.3.3
cd %{_builddir}/google-auth-2.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641439718
...
cp %{_builddir}/google-auth-2.3.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_auth/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
