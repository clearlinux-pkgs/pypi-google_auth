...
Source0  : https://files.pythonhosted.org/packages/09/be/56d3c1db93d85e53ffa4eb26a2f41b0df9ba00317ee1f253121c63489d03/google-auth-2.16.2.tar.gz
...
%prep
%setup -q -n google-auth-2.16.2
cd %{_builddir}/google-auth-2.16.2
pushd ..
cp -a google-auth-2.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677859888
