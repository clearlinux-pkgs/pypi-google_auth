...
Source0  : https://files.pythonhosted.org/packages/6a/71/4c5387d8a3e46e3526a8190ae396659484377a73b33030614dd3b28e7ded/google_auth-2.36.0.tar.gz
...
%prep
%setup -q -n google_auth-2.36.0
cd %{_builddir}/google_auth-2.36.0
pushd ..
cp -a google_auth-2.36.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730930644
