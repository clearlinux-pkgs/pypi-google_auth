...
Source0  : https://files.pythonhosted.org/packages/9b/5d/f931f93183069e0bee341bc06040c8a15f381fbe69fe060f0871132a720e/google-auth-2.10.0.tar.gz
...
%prep
%setup -q -n google-auth-2.10.0
cd %{_builddir}/google-auth-2.10.0
pushd ..
cp -a google-auth-2.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659970975
