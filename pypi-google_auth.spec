...
Source0  : https://files.pythonhosted.org/packages/19/dd/48e06d7ce02ebf53a2d36fcada99c68d7f6b10f2058ec4f76f7e2e81d9e6/google-auth-2.12.0.tar.gz
...
%prep
%setup -q -n google-auth-2.12.0
cd %{_builddir}/google-auth-2.12.0
pushd ..
cp -a google-auth-2.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664327176
