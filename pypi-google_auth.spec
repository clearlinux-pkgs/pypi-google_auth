...
Source0  : https://files.pythonhosted.org/packages/22/1d/65514adf8e2fc3546f4fc7025afe00828597eb98c414ef3327867dc263c6/google-auth-2.28.0.tar.gz
...
%prep
%setup -q -n google-auth-2.28.0
cd %{_builddir}/google-auth-2.28.0
pushd ..
cp -a google-auth-2.28.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708034436
