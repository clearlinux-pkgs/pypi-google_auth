...
Source0  : https://files.pythonhosted.org/packages/be/f6/b22ef3a4b24b5b0d0fcf8426080eab66ccdfaaf73a61e37e76693c43f7f6/google-auth-2.30.0.tar.gz
...
%prep
%setup -q -n google-auth-2.30.0
cd %{_builddir}/google-auth-2.30.0
pushd ..
cp -a google-auth-2.30.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717773277
