...
Source0  : https://files.pythonhosted.org/packages/8c/a3/cc4dc2e8a7f67012a26dec5b6b1fdf5261b12e7d54981c88de2580315726/google_auth-2.32.0.tar.gz
...
%prep
%setup -q -n google_auth-2.32.0
cd %{_builddir}/google_auth-2.32.0
pushd ..
cp -a google_auth-2.32.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720541938
