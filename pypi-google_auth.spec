...
Source0  : https://files.pythonhosted.org/packages/f8/42/abd9c0c192314f8ec494c9ee7b5bde4348dff986fe0e8f26c8c59e9897e4/google-auth-2.6.0.tar.gz
...
%prep
%setup -q -n google-auth-2.6.0
cd %{_builddir}/google-auth-2.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643733393
...
cp %{_builddir}/google-auth-2.6.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_auth/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
