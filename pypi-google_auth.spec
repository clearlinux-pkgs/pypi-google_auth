...
Source0  : https://files.pythonhosted.org/packages/a9/b8/106bf395ad5be94bfd1e4c157a36db6dfcca445f72ff63458358d9203157/google-auth-2.16.0.tar.gz
...
%prep
%setup -q -n google-auth-2.16.0
cd %{_builddir}/google-auth-2.16.0
pushd ..
cp -a google-auth-2.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673369085
